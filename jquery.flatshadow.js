...
//  var angles = new Array("NE","SE","SW", "NW");
  var colors = new Array("#98FB98","#7FFFD4","#B0E0E6","#87CEEB");
  var angles = new Array("SE");
  ...
  $.fn.flatshadow = function(options){
    ...
    return this.each(function(){
      ...
      // ↓↓↓ 追加 2014/05/07 ↓↓↓
      if(settings.colornum <= colors.length && settings.colornum >= 0)
      {
        color = colors[settings.colornum];
      }
      // ↑↑↑ 追加 2014/05/07 ↑↑↑
